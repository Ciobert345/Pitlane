...
export default function HelpPage() {
	return (
		<div>
			...
			<p>This page explains some core features and UI elements of Pitlane.</p>

			<h2 className="my-4 text-2xl">Colors</h2>

			<p>
				A core element in the UI of Pitlane, inspired by official Formula 1 graphics, is the color-coding system used
			...
			<p className="mb-4">
				When using Pitlane while watching on TV, F1TV, or your favorite streaming platform, you may notice that Pitlane
				updates much earlier than your stream. This can make exciting race events less interesting, as you see them on
				Pitlane before experiencing them on your stream. This is where the delay control comes in.
			</p>

			<p className="mb-4">
				With delay control, you can set a delay in seconds to make Pitlane update later than it normally would. So
				setting a 30-second delay will cause Pitlane to update 30 seconds later than it normally would.
				<br />
				You can use this to sync your stream with Pitlane.
			</p>
