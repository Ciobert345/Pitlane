...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
	...
	return (
		<Link
			className={`rounded-xl px-3 py-2.5 text-sm font-medium transition-all active:scale-95 ${
				isActive
...
export default function NavBar() {
	return (
		<nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-zinc-950/80 shadow-lg backdrop-blur-xl">
